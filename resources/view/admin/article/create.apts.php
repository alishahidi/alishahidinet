...
<title>پنل ادمین ساخت مقاله</title>
@endsection
...
<div class="card-content">
    <div class="card-title">
        <div class="title d-flex align-items-center">
            ...
            <span class="text">ساخت مقاله جدید</span>
        </div>
    </div>
    <div class="card-body">
        <div class="card-table">
            ...
            <div class="mt-5">
                ...
                <?php } ?>
                <form action="<?= route('admin.article.store') ?>" method="POST" class="form row g-3" enctype="multipart/form-data" id="form">
                    @token
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        <select name="topic_id" class="form-select form-control">
                            <?php foreach ($topics as $topic) {  ?>
                                <option value="<?= $topic->id ?>" <?= oldEqualValue('topic_id', $topic->id) ? 'selected' : '' ?>> <?= e($topic->name) ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    ...
                    <div class="col-12 mt-2">
                        ...
                        <textarea id="editor" name="content"><?= d(old('content')) ?></textarea>
                    </div>
