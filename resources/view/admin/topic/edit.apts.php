...
@section('head-tag')
<title>پنل ادمین ویرایش تاپیک</title>
@endsection
...
<div class="card-content">
    <div class="card-title">
        <div class="title d-flex align-items-center">
            ...
            <span class="text">ویرایش تاپیک</span>
        </div>
    </div>
    <div class="card-body">
        <div class="card-table">
            ...
            <div class="mt-5">
                ...
                <?php } ?>
                <form action="<?= route('admin.topic.update', [$topic->id]) ?>" method="POST" class="form row g-3">
                    @token
                    @method('PUT')
                    <div class="col-12 mt-2">
                        <label for="name" class="form-label mb-3">اسم:</label>
                        <input type="text" name="name" class="form-control" id="name" placeholder="اسم" value="<?= e(oldOr('name', e($topic->name))) ?>">
                    </div>
