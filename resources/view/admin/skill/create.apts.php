...
@section('head-tag')
<title>پنل ادمین ساخت مهارت</title>
@endsection
...
<div class="card-content">
    <div class="card-title">
        <div class="title d-flex align-items-center">
            ...
            <span class="text">ساخت مهارت جدید</span>
        </div>
    </div>
    <div class="card-body">
        <div class="card-table">
            ...
            <div class="mt-5">
                ...
                <?php } ?>
                <form action="<?= route('admin.skill.store') ?>" method="POST" class="form row g-3">
                    @token
                    ...
                    <div class="col-12 mt-2">
                        ...
                        <input type="number" name="percent" class="form-control" id="percent" placeholder="درصد" value="<?= e(old('percent')) ?>">
                    </div>
