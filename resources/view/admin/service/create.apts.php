...
@section('head-tag')
<title>پنل ادمین ساخت سرویس</title>
@endsection
...
<div class="card-content">
    <div class="card-title">
        <div class="title d-flex align-items-center">
            ...
            <span class="text">ساخت سرویس جدید</span>
        </div>
    </div>
    <div class="card-body">
        <div class="card-table">
            ...
            <div class="mt-5">
                ...
                <?php } ?>
                <form action="<?= route('admin.service.store') ?>" method="POST" class="form row g-3">
                    @token
                    ...
                    <div class="col-12 mt-2">
                        <label for="icon" class="form-label mb-3">آیکون: (ionicons)</label>
                        <input type="text" name="icon" class="form-control" id="icon" placeholder="آیکون" value="<?= e(old('icon')) ?>">
                    </div>
